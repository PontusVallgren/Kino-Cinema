...
export default function Contact() {
  ...
  return (
    // <Box sx={{ height: "2px" }}>
    <Box className={classes.bigBox} sx={{ width: "100%", typography: "body1" }}>
      <TabContext value={value}>
        ...
        <TabPanel className={classes.smallBox} value="3">
          ...
          <p>
            ...
            som ger filmen en åldersgräns enligt gällande regler och riktlinjer
            för åldergräns på film. Vårt uppdrag är att säkerställa att dessa
            följs på biografen
            <a
              className={classes.statensmedie}
          ...
          <p className={classes.ages}>
            ...
            Personen har fyllt 18 år och är myndig. Man behöver vara beredd att
            kunna styrka sin ålder med en ID-handling, till exempel giltig
            legitimation, körkort eller pass.
          </p>
          <p className={classes.ages}>
            <strong>15-årsgräns: </strong> Personen har fyllt 15 år.
            15-årsgränsen betyder att en film har bedömts kunna vara till skada
            för välbefinnandet för barn under 15 år.
          </p>
          <p className={classes.ages}>
